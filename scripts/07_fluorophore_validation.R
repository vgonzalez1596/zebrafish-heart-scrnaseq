...
blend_plot_16s[[4]] <- blend_plot_16s[[4]] +
  labs(x = "zsyellow", y = "nkx2.5") +
  theme(axis.title.x = element_text(face = "italic"), axis.title.y = element_text(face = "italic"))
...
# -------------------------------#
# 2) 18 ss: ZsYellow + nkx2.5
# -------------------------------#

heart18s <- CreateSeuratObject(
  counts = heart18s_fluoro.data,
  project = "18somdata_fluorophore",
  min.cells = 3,
  min.features = 200
)
...
blend_plot_18s[[4]] <- blend_plot_18s[[4]] +
  labs(x = "zsyellow", y = "nkx2.5") +
  theme(axis.title.x = element_text(face = "italic"), axis.title.y = element_text(face = "italic"))
...
heart20s <- CreateSeuratObject(
  counts = heart20s_fluoro.data,
  project = "20somdata_fluorophore",
  min.cells = 3,
  min.features = 200
)
...
blend_plot_20s[[4]] <- blend_plot_20s[[4]] +
  labs(x = "egfp", y = "myl7") +
  theme(axis.title.x = element_text(face = "italic"), axis.title.y = element_text(face = "italic"))
